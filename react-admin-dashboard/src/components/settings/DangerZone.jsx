	...
	return (
		...
		>
			<div className='flex items-center mb-4'>
				...
				<h2 className='text-xl font-semibold text-theme-text-primary'>Xóa tài khoản</h2>
			</div>
			<p className='text-theme-text-secondary mb-4'>Hãy cân nhắc kĩ trước khi thực hiện.</p>
			<button

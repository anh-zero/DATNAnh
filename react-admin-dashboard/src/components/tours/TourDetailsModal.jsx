...
import {
    ...
    Tag, CalendarDays // Thêm các icon này
} from 'lucide-react';
    ...
    return (
        <>
            <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-50 flex items-center justify-center p-4">
                <motion.div
                    className="bg-white dark:bg-theme-surface0 rounded-lg w-full max-w-3xl relative border border-theme-border max-h-[90vh] flex flex-col shadow-xl p-6"
            ...
            {showEditModal && (
                <TourFormModal
                    ...
                    onClose={() => {
                        ...
                        onClose(); // Đóng cả modal chi tiết khi đóng modal chỉnh sửa
                    }}
                    tour={tour}
                />
            )}
